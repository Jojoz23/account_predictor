#!/usr/bin/env python3
"""
Batch test all CIBC USD statements
"""

import sys
from pathlib import Path
from test_cibc_usd_complete import extract_cibc_usd_statement

def test_all_cibc_usd():
    """Test all CIBC USD PDFs"""
    ...
    print(f"="*80)
    print(f"BATCH TEST: CIBC USD Statements")
    print(f"="*80)
    ...
    for pdf_file in pdf_files:
        ...
        try:
            result = extract_cibc_usd_statement(str(pdf_file))
